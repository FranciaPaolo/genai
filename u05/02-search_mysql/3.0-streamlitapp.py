...
# streamlit run 3.0-streamlitapp.py
#
# in the prompt you can ask
# show me all the records of the tables
# display the list of students with marks greater than 45 
